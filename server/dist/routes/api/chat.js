...
router.post("/join", (req, res) => {
    ...
    Chat.findOne({ roomName }).then(chat => {
        if (!chat)
            return res.status(400).json({ err: "Chat doesn't exist" });
        // Validating password
